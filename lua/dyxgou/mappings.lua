...
map("n", "<C-d>", "<C-d>zz")
map("n", "<C-u>", "<C-u>zz")
map("n", "<leader>x", "<cmd>q<CR>", { desc = "Close and save the buffer" })
...
map("n", "<leader>pm", builtin.marks, { desc = "Find marks in all buffers" })
map("n", "<leader>pd", builtin.lsp_document_symbols, { desc = "Find symbols in the current file" })
--- Obsidian
...
map("n", "<leader>z", toggleZenMode(), { desc = "Toggle zen mode" })

map("n", "<leader>t", "<cmd>DBUIToggle<CR>", { desc = "Toggle DB UI" })
map("n", "<leader>n", "<cmd>tabnew<CR>", { desc = "Creates a new tab" })
